...
// checkOpenMP
bool checkOpenMP();
RcppExport SEXP _n2Knn_checkOpenMP() {
BEGIN_RCPP
...
RcppExport SEXP _n2Knn_n2Knn(SEXP mSEXP, SEXP kSEXP, SEXP nThreadsSEXP, SEXP verboseSEXP, SEXP indexTypeSEXP, SEXP MSEXP, SEXP MaxM0SEXP, SEXP ef_search_multiplierSEXP, SEXP quietSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _n2Knn_n2CrossKnn(SEXP mASEXP, SEXP mBSEXP, SEXP kSEXP, SEXP nThreadsSEXP, SEXP verboseSEXP, SEXP indexTypeSEXP, SEXP MSEXP, SEXP MaxM0SEXP, SEXP ef_search_multiplierSEXP, SEXP quietSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_n2Knn_checkOpenMP", (DL_FUNC) &_n2Knn_checkOpenMP, 0},
    {"_n2Knn_n2Knn", (DL_FUNC) &_n2Knn_n2Knn, 9},
    {"_n2Knn_n2CrossKnn", (DL_FUNC) &_n2Knn_n2CrossKnn, 10},
    {NULL, NULL, 0}
};

RcppExport void R_init_n2Knn(DllInfo *dll) {
